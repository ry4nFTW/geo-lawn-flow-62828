  ...
  public: {
    Tables: {
      ...
      auto_populations: {
        ...
        Relationships: [
          {
            foreignKeyName: "auto_populations_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
      ...
      chat_messages: {
        Row: {
          ...
          sender_type: Database["public"]["Enums"]["chat_sender"]
        }
        Insert: {
          created_at?: string | null
          customer_id?: string | null
      ...
      jobs: {
        Row: {
          ...
          address: string
          auto_populated_confidence: number | null
          created_at: string | null
          customer_id: string | null
      ...
      visits: {
        ...
        Relationships: [
          {
            foreignKeyName: "visits_crew_id_fkey"
            columns: ["crew_id"]
            isOneToOne: false
            referencedRelation: "crews"
            referencedColumns: ["id"]
    ...
    Enums: {
      chat_sender: "customer" | "crew" | "manager"
      crew_role: "lead" | "member" | "trainee"
